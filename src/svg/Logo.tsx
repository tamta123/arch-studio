...
const Logo: React.FC<{ dark: boolean }> = ({ dark }) => {
  // რეაქტის ფუნქციური კომპონენტი, ჯენერიკი ვნახო წინა ლექციაში (პროფსმა უნდა მიიღოს ასეტი ტიპის ობიექტი, რომელსაც ექნება ფროფერთი
  // დარქი, რომელიც უნდა იყოს ბულიანი (თრუ ან ფოლსი), შესაბამისად დესტრუქტურიზაციაში პროპსისც შეგვიძლია გამოვიყენოთ დარქის მაგივრად
  //  ), დესტრუქტურიზაციით დარქი გამოვიტანოთ
  return (
    <Svg>
      <path
        fill={dark ? "#1B1D23" : "#ffff "}
